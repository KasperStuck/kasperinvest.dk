...
const lessons = [
    ...
    lessons: [
      {
        ...
        description:
          "Sæt rammer, forventninger og risikodisclaimer.",
        video: null,
      },
      {
        ...
        description:
          "Lav et budget med faste og variable poster samt buffer.",
        video: null,
      },
      {
        ...
        description:
          "Implementer rutiner: månedlig status og årlig plan.",
        video: null,
      },
      {
        ...
        description:
          "Skelne mellem frihedsmål og investeringsmål; undgå urealistiske tal.",
        video: null,
      },
      {
        ...
        description:
          "Forskel på aktiv og passiv indkomst og administrative krav.",
        video: null,
      },
      {
        ...
        description:
          "Forstå proces, beslutningspunkter og samspil mellem økonomi og boligskat.",
        video: null,
      },
      {
        ...
        description:
          "Sammenlign sikkert afkast ved gældsafvikling med markedsrisiko.",
        video: null,
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description:
          "Lær at skelne inspiration fra metode og undgå survivorship bias.",
        video: null,
      },
      {
        id: "renters-rente",
        ...
        description:
          "Beregn effekt af tid, indbetaling og afkast.",
        video: null,
      },
      {
      ...
      },
      {
        ...
        description:
          "Forstå risikopræmie, diversifikation og disciplin som drivere.",
        video: null,
      },
      {
        ...
        description:
          "Forstå valutarisiko ved udenlandske ETF'er og eksponering mod USD/EUR.",
        video: null,
      },
      {
        ...
        description:
          "Vælg en simpel proces: mål, tid, risiko, produkt og rutine.",
        video: null,
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description:
          "Udbytte vs. kursgevinst; risiko og diversifikation.",
        video: null,
      },
      {
        ...
        description:
          "Bred eksponering, omkostninger og dokumenter (PRIIP KID).",
        video: null,
      },
      {
        id: "obligationer",
        ...
        description:
          "Renterisiko, kursfølsomhed og porteføljerolle.",
        video: null,
      },
      {
        ...
        description:
          "Stil de rigtige spørgsmål til bæredygtighed og dokumentation.",
        video: null,
      },
      {
        ...
        description:
          "Byg en policy-portefølje med udgangspunkt i aktivklasser.",
        video: null,
      },
    ],
  },
  {
    ...
    description:
      "Byg en strategi der passer til din risikoprofil og kan fastholdes i nedture.",
    lessons: [
      {
        id: "hvad-er-en-investeringsstrategi",
        title: "Definér din investeringsstrategi",
        description:
          "Skelne mellem strategi, taktik og spekulation.",
        video: null,
      },
      {
        ...
        description:
          "Forstå tabstolerance, tidshorisont og kapacitet til risiko.",
        video: null,
      },
      {
        ...
        description:
          "Identificer tabsaversion og overkonfidens samt byg procesværn.",
        video: null,
      },
      {
        ...
        description:
          "Vælg strategi ud fra adfærd, omkostninger og dokumentation.",
        video: null,
      },
      {
        id: "rebalancering",
        ...
        description:
          "Forstå hvornår og hvordan du genopretter din målallokering.",
        video: null,
      },
      {
        ...
        description:
          "Forstå planlagt adfærd ved fald og stress-scenarier.",
        video: null,
      },
    ],
  },
  {
    ...
    title: "Analyse",
    description:
      "Læs regnskab, lav fundamental analyse og forstå teknisk analyse som værktøj.",
    lessons: [
      {
        id: "intro-regnskaber",
        title: "Læs regnskaber og nøgletal",
        description:
          "Forstå resultat, balance, cash flow og nøgleindikatorer.",
        video: null,
      },
      {
        ...
        description:
          "Strukturer analyse: forretningsmodel, moat, risici og værdi.",
        video: null,
      },
      {
        ...
        description:
          "Træn hele analyseprocessen med fokus på metode og dokumentation.",
        video: null,
      },
      {
        id: "teknisk-analyse",
        ...
        description:
          "Forstå støtte/modstand, trend og volumen som sprog, ikke garanti.",
        video: null,
      },
      {
        ...
        description:
          "Læs KID, forstå indeks/metode, omkostninger og skattemæssig status.",
        video: null,
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description:
          "Forstå kontorammer: aktiedepot vs. aktiesparekonto vs. pension.",
        video: null,
      },
      {
        ...
        description:
          "Opret depot, forstå funktioner og find rapporter og omkostninger.",
        video: null,
      },
      {
        ...
        description:
          "Identificer kurtage, spread og valutaveksling som friktion.",
        video: null,
      },
      {
        id: "maanedsopsparing",
        ...
        description:
          "Implementer regelmæssig investering og reducér timing-stress.",
        video: null,
      },
      {
        ...
        description:
          "Forstå pensionsafkastbeskatning (PAL) og scenarier.",
        video: null,
      },
      {
        ...
        description:
          "Forstå børneopsparingens rammer og alternativ struktur.",
        video: null,
      },
      {
        ...
        description:
          "Forstå virksomhedens skattemæssige rammer for investeringsmuligheder.",
        video: null,
      },
    ],
  },
  {
    ...
    description:
      "Forstå skat som del af nettoafkast og opdater forskud/årsopgørelse korrekt.",
    lessons: [
      {
        id: "skat-fra-bunden",
        title: "Forstå skat fra bunden",
        description:
          "Skelne mellem brutto- og nettoafkast; forstå lager vs. realisation.",
        video: null,
      },
      {
        id: "fradrag",
        ...
        description:
          "Brug Skattestyrelsens fradragsguide og dokumentér ændringer.",
        video: null,
      },
      {
        id: "skat-af-aktier",
        ...
        description:
          "Forstå aktieindkomst og 2026-satser samt indberetningslogik.",
        video: null,
      },
      {
        ...
        description:
          "Vælg kontotype og produkt med fokus på lovlighed og enkelhed.",
        video: null,
      },
      {
        ...
        description:
          "Forstå forskudsopgørelsen som budget og ret ved ændringer.",
        video: null,
      },
    ],
  },
  {
    ...
    description:
      "Planlæg udbetalinger, håndter sekvensrisiko og kobl frie midler med pension.",
    lessons: [
      {
        id: "generelt-om-nedsparing",
        title: "Forstå nedsparing og sekvensrisiko",
        description:
          "Forstå forskellen på opsparing og udbetaling samt sekvensrisiko.",
        video: null,
      },
      {
        ...
        description:
          "Vælg mellem faste og fleksible regler samt buffertyper.",
        video: null,
      },
      {
        ...
        description:
          "Samspil mellem pension og frie midler ved udbetaling og skatteoptimering.",
        video: null,
      },
      {
        id: "levetidsrisiko",
        ...
        description:
          "Planlæg for at pengene rækker hele livet og forstå longevity-risiko.",
        video: null,
      },
      {
        ...
        description:
          "Skab governance: rebalancering, skatterytme og udgiftsstyring.",
        video: null,
      },
      {
        ...
        description:
          "Oversæt principper og kriterier til din egen udbetalingsplan.",
        video: null,
      },
    ],
  },
