...
export async function getElectionArticleContent(year: number, slug: string) {
	...
	const match = Object.entries(modules).find(
		([path]) => path.includes(`folketingsvalg-${year}/`) && path.endsWith(`/${slug}.mdx`),
	);
	if (!match) {
...
const elections: Election[] = [
	{
		...
		articles: [
			...
			},
			{
				...
				description: "Formueskat på 0,5% over høje grænser og konsekvenser for investorer.",
			},
			{
				id: "radikale-venstre",
			...
			},
			{
				...
				description: "Lavere skattetryk, forenkling og boligskattestop.",
			},
			{
				id: "sf",
				title: "SF – Socialistisk Folkeparti (F)",
				description: "Formueskat og højere skat på aktieindkomst for topskatteydere.",
			},
			{
				id: "borgernes-parti",
				title: "Borgernes Parti (H)",
				description: "Afskaffelse af topskat og top-topskat; lavere skatter og bureaukrati.",
			},
			{
				id: "liberal-alliance",
			...
			},
			{
				id: "moderaterne",
				title: "Moderaterne (M)",
				description: "Lavere skat på investeringer mod skat på større boliggevinster ved salg.",
			},
			{
				id: "dansk-folkeparti",
				title: "Dansk Folkeparti (O)",
				description: "Lavere skat for almindelige indkomster og lavere afgifter/moms på fødevarer.",
			},
			{
				id: "venstre",
				title: "Venstre (V)",
				description: "Skattestop, gradvise lettelser og markant modstand mod formueskat.",
			},
			{
				id: "danmarksdemokraterne",
				title: "Danmarksdemokraterne (Æ)",
				description: "Skatteforenkling og ønske om et simplere skattesystem.",
			},
			{
				id: "enhedslisten",
			...
			},
			{
				...
				description: "Grøn skatteomlægning med højere afgifter på forurening og overforbrug.",
			},
		],
	},
	{
		...
		articles: [
			...
			},
			{
				...
				description: "Økonomisk liberalisme med lavere skat, færre regler og stærk ejendomsret.",
			},
			{
				id: "sf",
				title: "SF – Socialistisk Folkeparti (F)",
