...
export const GET: APIRoute = () => {
	...
	for (const pension of getPensionTypes()) {
		lines.push(
			`- [${pension.title}](https://kasperinvest.dk/pension/${pension.id}): ${pension.description}`,
		);
	}
	lines.push("");
	...
	for (const platform of getPlatforms()) {
		lines.push(
			`- [${platform.title}](https://kasperinvest.dk/platforme/${platform.id}): ${platform.description}`,
		);
	}
	lines.push("");
	...
	lines.push("En samling af bøger, podcasts og gratis værktøjer til investering.");
	lines.push("");
...
const booksDanish = [
	...
	{
		title: "Den lille guide til fundamental analyse",
		author: "Martin Gottlob & Sarah Ophelia Møss",
	},
	{ title: "Den lille guide til teknisk analyse", author: "Nanna Fick" },
	{
		title: "Den lille guide til investering i teknologiaktier",
		author: "Jesper Bæk & Mads Christiansen",
	},
	{
		title: "Girls Just Wanna Have Funds",
		author: "Anna-Sophie Hartvigsen, Camilla Falkenberg & Emma Due Bitz",
	},
...
const podcasts = [
	{
		title: "Millionærklubben",
		description: "Euroinvestors daglige podcast om aktieanalyse, markedstendenser og makroøkonomi.",
	},
	{
		title: "Børssnak",
		description: "Saxo Banks ugentlige 10-minutters podcast der klæder dig på til ugen på børsen.",
	},
	{
		title: "Saxo Market Call",
		description: "Saxo Banks daglige markedsanalyse med global finansoverblik.",
	},
	{
		title: "Investeringspodcasten",
		description:
			"Nordnets ugentlige podcast med Per Hansen og Helge Larsen om markedstrends og aktier.",
	},
	{
		title: "Store Penge",
		description: "Ekstra Bladets finanspodcast om makroøkonomi og geopolitik, 3x ugentligt.",
	},
	{
		title: "Børsen Investor",
		description: "Børsens ugentlige podcast med professionelle investorer der analyserer aktier.",
	},
	{
		title: "Ophelias Invest Talk",
		description:
			"Sarah Ophelia Møss' ugentlige podcast om investering, opsparing og privatøkonomi.",
	},
	{
		title: "Kurs mod ugen",
		description: "Dansk Aktionærforenings ugentlige lørdag-overblik over globale finansmarkeder.",
	},
	{
		title: "Kvinde, kend din kurs",
		description: "Female Invests ugentlige podcast med aktie-updates og investering for kvinder.",
	},
	{
		title: "Aktieuniverset",
		description: "Mads Christiansens podcast for både nye og erfarne investorer.",
	},
	{
		title: "Investering på hjernen",
		description: "Jens Balles podcast om investorpsykologi og de mentale fælder ved investering.",
	},
	{
		title: "Ejendomsinvestoren",
		description: "Podcast udelukkende om ejendomsinvestering — handler, strategier og lån.",
	},
	{
		title: "PengePulsen",
		description: "Nordeas podcast om privatøkonomi, investeringer, boligmarked og pension.",
	},
	{
		title: "Pengestærk",
		description: "Arbejdernes Landsbanks podcast om investering for begyndere og erfarne.",
	},
];
...
const tools = [
	{
		title: "justETF",
		description: "Søg, sammenlign og analyser ETF'er for europæiske investorer.",
	},
	{ title: "Yahoo Finance", description: "Watchlists, porteføljesporing og aktiescreener." },
	{
		title: "TradingView",
		description: "Aktiescreener med fundamentale nøgletal og tekniske indikatorer.",
	},
	{
		title: "Koyfin",
		description: "Research, dashboards og porteføljeoverblik for aktier, ETF'er og fonde.",
	},
	{
		title: "CompaniesMarketCap",
		description: "Hurtig sammenligning af selskabers størrelse og markedsværdi.",
	},
	{
		title: "Morningstar",
		description: "Screener med ratings og analyser for aktier, fonde og ETF'er.",
	},
	{
		title: "Finviz",
		description: "Gratis aktiescreener med 60+ filtre, heatmaps og tekniske mønstre.",
	},
	{ title: "TIKR", description: "Aktieanalyse med screener og finansielle data 10+ år tilbage." },
	{
		title: "Curvo Backtest",
		description: "Test historisk performance af ETF-porteføljer for europæiske investorer.",
	},
	{
		title: "FRED",
		description: "840.000+ økonomiske dataserier fra hele verden til makroanalyse.",
	},
	{
		title: "Sharesight",
		description: "Portefølje-tracker med automatisk udbyttesporing og Nordnet-integration.",
	},
	{
		title: "SEC EDGAR",
		description: "Gratis adgang til amerikanske selskabers årsrapporter og regnskaber.",
	},
];
